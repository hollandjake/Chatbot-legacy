...
public class Chatbot {
	...
	public Chatbot(HashMap<String, String> config) throws MissingConfigurationsException {
		...
		webController.gotoFacebookThread(this.threadName);
	...
	public void sendMessage(List<MessageComponent> components) {
		sendMessage(new Message(me, components, null, 0));
	}
	...
	public void sendImageWithMessage(String url, String message) {
